...
//    @PostConstruct
    ...
    private void initGatewayRules() {
        ...
        rule.setResource("fox-nacos-client");
        // 按照 QPS 限流
    ...
    private void initBlockHandler() {
        ...
        BlockRequestHandler blockRequestHandler = new BlockRequestHandler() {
            ...
            public Mono<ServerResponse> handleRequest(ServerWebExchange serverWebExchange,
                ...
                result.put("route", "fox-nacos-client");
    ...
    private void initCustomizedApis() {
        ...
        ApiDefinition api = new ApiDefinition("nacos-client-api")
                .setPredicateItems(new HashSet<ApiPredicateItem>() {{
                    // 模糊匹配 /fox/fox-nacos-client/ 及其子路径的所有请求
                    add(new ApiPathPredicateItem()
                            .setPattern("/fox/fox-nacos-client/**")
                            // 根据前缀匹配
        ...
        ApiDefinition api1 = new ApiDefinition("nacos-client-api-1")
                .setPredicateItems(new HashSet<ApiPredicateItem>() {{
                    add(new ApiPathPredicateItem()
                            ...
                            .setPattern("/fox/fox-nacos-client/nacos-client/service-instance"));
                }});
        ...
        ApiDefinition api2 = new ApiDefinition("nacos-client-api-2")
                .setPredicateItems(new HashSet<ApiPredicateItem>() {{
                    add(new ApiPathPredicateItem()
                            // 精确匹配 /fox/fox-nacos-client/nacos-client/project-config
                            .setPattern("/fox/fox-nacos-client/nacos-client/project-config"));
                }});
